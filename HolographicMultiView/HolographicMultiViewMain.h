...
{
    class HolographicMultiViewMain : public DX::IDeviceNotify
    {
    public:
        HolographicMultiViewMain(const std::shared_ptr<DX::DeviceResources>& deviceResources);
        ~HolographicMultiViewMain();
