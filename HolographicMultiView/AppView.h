...
namespace HolographicMultiView
{
    ...
    public:
		...
		static void RunXAMLView();
		static void RunXAMLCallback(Windows::UI::Xaml::ApplicationInitializationCallbackParams^ params);
    ...
    private:
        std::unique_ptr<HolographicMultiViewMain> m_main;
