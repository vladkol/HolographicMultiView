...
void AppView::RunXAMLView()
{
	Windows::UI::Xaml::Application::Start(ref new Windows::UI::Xaml::ApplicationInitializationCallback(&AppView::RunXAMLCallback));
}

void AppView::RunXAMLCallback(Windows::UI::Xaml::ApplicationInitializationCallbackParams^ params)
{
	ref new HolographicXAMLView::App();
}
...
void AppView::Initialize(CoreApplicationView^ applicationView)
{
    ...
    m_main = std::make_unique<HolographicMultiViewMain>(m_deviceResources);
}
