#include "pch.h"
#include "HolographicMultiViewMain.h"
...
using namespace HolographicMultiView;
...
HolographicMultiViewMain::HolographicMultiViewMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
    m_deviceResources(deviceResources)
{
    ...
    m_gamepadAddedEventToken = Gamepad::GamepadAdded +=
        ref new EventHandler<Gamepad^>(
            bind(&HolographicMultiViewMain::OnGamepadAdded, this, _1, _2)
            );

    m_gamepadRemovedEventToken = Gamepad::GamepadRemoved +=
        ref new EventHandler<Gamepad^>(
            bind(&HolographicMultiViewMain::OnGamepadRemoved, this, _1, _2)
            );
...
void HolographicMultiViewMain::SetHolographicSpace(HolographicSpace^ holographicSpace)
{
    ...
    m_holographicDisplayIsAvailableChangedEventToken = HolographicSpace::IsAvailableChanged +=
        ref new EventHandler<Object^>(
            bind(&HolographicMultiViewMain::OnHolographicDisplayIsAvailableChanged, this, _1, _2)
            );
    ...
    m_cameraAddedToken =
        m_holographicSpace->CameraAdded +=
            ref new TypedEventHandler<HolographicSpace^, HolographicSpaceCameraAddedEventArgs^>(
                std::bind(&HolographicMultiViewMain::OnCameraAdded, this, _1, _2)
                );
    ...
    m_cameraRemovedToken =
        m_holographicSpace->CameraRemoved +=
            ref new TypedEventHandler<HolographicSpace^, HolographicSpaceCameraRemovedEventArgs^>(
                std::bind(&HolographicMultiViewMain::OnCameraRemoved, this, _1, _2)
                );
...
void HolographicMultiViewMain::UnregisterHolographicEventHandlers()
{
...
HolographicMultiViewMain::~HolographicMultiViewMain()
{
...
HolographicFrame^ HolographicMultiViewMain::Update()
{
...
bool HolographicMultiViewMain::Render(HolographicFrame^ holographicFrame)
{
...
void HolographicMultiViewMain::SaveAppState()
{
    //
...
void HolographicMultiViewMain::LoadAppState()
{
    //
...
void HolographicMultiViewMain::OnPointerPressed()
{
    m_pointerPressed = true;
}
...
void HolographicMultiViewMain::OnDeviceLost()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void HolographicMultiViewMain::OnDeviceRestored()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void HolographicMultiViewMain::OnLocatabilityChanged(SpatialLocator^ sender, Object^ args)
{
...
void HolographicMultiViewMain::OnCameraAdded(
...
void HolographicMultiViewMain::OnCameraRemoved(
    HolographicSpace^ sender,
...
void HolographicMultiViewMain::OnGamepadAdded(Object^, Gamepad^ args)
{
...
void HolographicMultiViewMain::OnGamepadRemoved(Object^, Gamepad^ args)
{
...
void HolographicMultiViewMain::OnHolographicDisplayIsAvailableChanged(Object^, Object^)
{
        ...
        if (spatialLocator != nullptr)
        {
            ...
            m_locatabilityChangedToken =
                ...
                ref new TypedEventHandler<SpatialLocator^, Object^>(
                    std::bind(&HolographicMultiViewMain::OnLocatabilityChanged, this, _1, _2)
                    );
